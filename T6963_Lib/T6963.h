...
public:
  ...
  void drawPic(unsigned int, unsigned int, const unsigned char *, unsigned int, unsigned int);
  void drawAnim(unsigned int, unsigned int, const unsigned char**, int, unsigned int, unsigned int);
