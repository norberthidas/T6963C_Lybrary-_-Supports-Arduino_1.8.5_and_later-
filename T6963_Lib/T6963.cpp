...
//-----------------------------------------------------------------------
 void T6963::drawPic(unsigned int x, unsigned int y, const unsigned char * PicName, unsigned int HEIGHT, unsigned int BYTEWIDTH) //HEIGHT = max 64;	//Height in pixels     BYTEWIDTH = max 40;	//Width in bytes by 6x8 Font
{ 
	byte bitmap;
	int j;
...
void T6963::drawAnim(unsigned int x, unsigned int y, const unsigned char** string_table, int l, unsigned int HEIGHT, unsigned int BYTEWIDTH) //Position x, Position y, String of Images , Number of Images ,HEIGHT,BYTEWIDTH show bmp2c Picturefile
{ 
    byte bitmap;
	int j;
	char* PicName;	 
